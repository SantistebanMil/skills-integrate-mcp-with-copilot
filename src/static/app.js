document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsHTML =
          details.participants.length > 0
            ...
            : `<p><em>Aún no hay participantes</em></p>`;

        // Formulario de registro individual
        const signupFormHTML = `
          <form class="activity-signup-form" data-activity="${name}">
            <input type="email" name="email" required placeholder="Correo del estudiante" />
      ...
      // Eventos para registro individual
  ...
  // Nuevo registro individual por actividad
